...
def outVideoAllCapture():
    ...
    while ret:
        ...
        if ret:
            ...
            imageToChar(out_path + str(num) + '.jpg', num)
...
def mergeImage(num):
    ...
    videoWriter = cv2.VideoWriter(out_path + 'out.mp4', fourcc, video_info[0], info[1])
    for i in range(num):
